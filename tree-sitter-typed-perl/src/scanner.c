...
unsigned int tree_sitter_typed_perl_external_scanner_serialize(void *payload, char *buffer) {
...
void tree_sitter_typed_perl_external_scanner_deserialize(void *payload, const char *buffer,
                                                   unsigned int length) {
  LexerState *state = payload;
  size_t size = 0;
...
bool tree_sitter_typed_perl_external_scanner_scan(void *payload, TSLexer *lexer,
...
void *tree_sitter_typed_perl_external_scanner_create() {
  ...
  tree_sitter_typed_perl_external_scanner_deserialize(state, NULL, 0);
  return state;
}
